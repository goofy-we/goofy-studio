...
export const DEFAULT_IMAGE_MODEL_ID = 'comfly/grok-4.2-image';

const imageModelAliasMap = new Map<string, string>([
  ['grok-4.2-image', 'comfly/grok-4.2-image'],
  ['grok-4.1-image', 'comfly/grok-4.1-image'],
  ['nano-banana-2', 'comfly/nano-banana-2'],
  ['gemini-3.1-flash-image', 'comfly/gemini-3.1-flash-image'],
  ['gemini-3.1-flash-image-preview', 'comfly/gemini-3.1-flash-image'],
]);
